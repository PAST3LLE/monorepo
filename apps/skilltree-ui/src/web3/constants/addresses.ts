...
export const CONTRACT_ADDRESSES_MAP = {
  [SupportedChains.GOERLI]: {
    ...
    skills: {
      1: '0x95649e31e9A88f3dCAD3F39022d220174b170B09',
...
export const METADATA_URIS_MAP = {
  [SupportedChains.GOERLI]: {
    ...
    skills: {
      1: 'ipfs://Qmdjdy57ptHQd3fWQnmAz8e4YMkdSBsGav6bT6LLe8nttH/{id}.json',
      2: 'ipfs://Qmdjdy57ptHQd3fWQnmAz8e4YMkdSBsGav6bT6LLe8nttH/{id}.json',
      3: 'ipfs://QmPVRrcb9jg2dewYC5fBTGYVbBG9ixLnYuz8z2BXammNm1/{id}.json'
    }
  },
  [SupportedChains.POLYGON_MUMBAI]: {
    collections: 'https://pstlcollections.s3.eu-south-2.amazonaws.com/collections/{id}.json',
