...
export const AccountBottomColumnContainer = styled(Column)`
  background-color: ${({ theme }) =>
    theme?.modals?.account?.balanceAndAddressContainer?.background?.background ||
    BaseTheme.modes.DEFAULT.modals?.account?.balanceAndAddressContainer?.background?.background};
`
